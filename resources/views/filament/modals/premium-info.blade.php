...
<div x-data="{
...
}" class="premium-modal-box space-y-5 text-slate-800 dark:text-slate-100" style="font-size: 1rem; line-height: 1.6;">

    {{-- Hero Offer Card --}}
    <div class="pm-hero" style="background: linear-gradient(135deg, #115e59 0%, #0f766e 50%, #065f46 100%); padding: 1.5rem 1.6rem; border-radius: 1.15rem; color: #ffffff;">
        <div style="flex: 1; min-width: 220px;">
            ...
            <p style="margin: 0.45rem 0 0; font-size: 0.95rem; color: #ccfbf1; opacity: 0.95; line-height: 1.5;">
                Publiez autant de produits que vous voulez sur Raaga sans aucune limite pendant toute l'année.
            </p>
        </div>
        ...
        <div style="background: rgba(255, 255, 255, 0.14); padding: 0.9rem 1.25rem; border-radius: 1rem; border: 1px solid rgba(255, 255, 255, 0.25); text-align: right; flex-shrink: 0;">
            <span style="display: block; font-size: 0.78rem; text-transform: uppercase; color: #99f6e4; font-weight: 700; letter-spacing: 0.05em;">Tarif Annuel</span>
            ...
            <span style="display: block; font-size: 0.78rem; color: #ccfbf1; margin-top: 0.2rem; font-weight: 500;">Valable 12 mois complets</span>
        </div>
    </div>
            ...
            <div style="display: flex; gap: 0.9rem; align-items: flex-start; flex: 1; min-width: 240px;">
                ...
                <div>
                    <div style="display: flex; align-items: center; gap: 0.5rem; flex-wrap: wrap;">
                        ...
                        <span style="font-size: 0.9rem; font-weight: 700; color: #1e293b;">Paiement de 5 050 FCFA</span>
                    </div>
                    <p style="margin: 0.4rem 0 0; font-size: 0.92rem; color: #475569; line-height: 1.5;">
                        Effectuez le transfert vers le numéro de paiement officiel :
                    </p>
    ...
    <div class="pm-step confirmation" style="border: 1px solid #99f6e4; background: linear-gradient(135deg, #f0fdfa 0%, #ecfdf5 100%); border-radius: 1rem; padding: 1.2rem 1.35rem;">
            ...
            <div style="display: flex; gap: 0.9rem; align-items: flex-start; flex: 1; min-width: 240px;">
                ...
                <div>
                    <div style="display: flex; align-items: center; gap: 0.5rem; flex-wrap: wrap;">
                        ...
                        <span style="font-size: 0.9rem; font-weight: 700; color: #1e293b;">Envoi de la preuve</span>
                    </div>
                    <p style="margin: 0.4rem 0 0; font-size: 0.92rem; color: #475569; line-height: 1.5;">
                        Numéro WhatsApp / Appel pour activer votre compte :
                    </p>
        ...
        <div style="margin-top: 0.9rem; background: #ffffff; border-radius: 0.75rem; padding: 0.9rem 1rem; border: 1px solid #ccfbf1; font-size: 0.9rem; color: #334155; line-height: 1.6;">
            <strong style="color: #0f766e; font-size: 0.92rem;">Consigne :</strong>
            « Après avoir effectué votre paiement, veuillez envoyer une capture d’écran de la transaction au <strong style="color: #0f172a; font-size: 0.95rem;">74 65 09 24</strong> afin que votre compte Premium puisse être activé. »
        </div>
    </div>

    {{-- Access Buttons --}}
    <div style="padding-top: 0.6rem; display: flex; flex-direction: column; gap: 0.75rem;">
        <a href="{{ $whatsappUrl }}" target="_blank" rel="noopener noreferrer"
           class="pm-btn-wa" style="padding: 1rem 1.5rem; font-size: 1rem;">
        ...
        <a href="tel:+226{{ str_replace(' ', '', $confirmationNumber) }}"
           class="pm-btn-phone" style="padding: 0.95rem 1.4rem; font-size: 0.95rem;">
