...
<div x-data="{ showModal: false }" class="fi-seller-premium-widget">
                ...
                <div style="display: flex; align-items: center; gap: 1.35rem; flex: 1; min-width: 280px;">
                    ...
                    <div>
                        ...
                        <p style="margin: 0.35rem 0 0; font-size: 1.02rem; color: #cbd5e1; line-height: 1.6; max-width: 660px;">
                            {{ __('Pour exposer autant de produits que vous le souhaitez sur Raaga, activez votre accès Premium pour seulement') }} <strong style="color: #fde047; font-weight: 900;">5 050 FCFA {{ __('pour toute l\'année') }}</strong> ({{ __('12 mois complets') }}).
                        </p>
                    </div>
                </div>
    ...
    {{-- Custom Styled Premium Modal (Scrollable, fully visible buttons, high contrast) --}}
    <div x-show="showModal"
        ...
        <div x-show="showModal"
             ...
             style="position: fixed; inset: 0; background: rgba(15, 23, 42, 0.78); backdrop-filter: blur(5px); transition: opacity 0.2s ease;"
        ...
        <div style="display: flex; min-height: 100vh; align-items: center; justify-content: center; padding: 1rem;">
            <div x-show="showModal"
                 ...
                 style="position: relative; width: 100%; max-width: 660px; max-height: calc(100vh - 2rem); display: flex; flex-direction: column; background: #ffffff; border-radius: 1.4rem; box-shadow: 0 25px 65px rgba(0,0,0,0.38); border: 1px solid rgba(226, 232, 240, 0.95); overflow: hidden; text-align: left; z-index: 10000;">
                
                {{-- Modal Header (Fixed) --}}
                <div style="flex-shrink: 0; display: flex; align-items: center; justify-content: space-between; padding: 1.1rem 1.6rem; background: #f8fafc; border-bottom: 1px solid #e2e8f0;">
                    <div style="display: flex; align-items: center; gap: 0.85rem;">
                        ...
                        <div>
                            ...
                            <p style="margin: 0.2rem 0 0; font-size: 0.85rem; color: #64748b; font-weight: 500;">{{ __('Paiement & Activation immédiate') }}</p>
                        </div>
                    </div>
                ...
                <div style="padding: 1.4rem 1.6rem 2rem; overflow-y: auto; flex: 1 1 auto; overscroll-behavior: contain; -webkit-overflow-scrolling: touch;">
                    @include('filament.modals.premium-info')
                </div>

                {{-- Modal Footer (Fixed) --}}
                <div style="flex-shrink: 0; display: flex; justify-content: flex-end; padding: 0.9rem 1.6rem; background: #f8fafc; border-top: 1px solid #e2e8f0;">
                    <button type="button" @click="showModal = false"
